...
func main() {
	...
	outputName := "fungen_auto.go"

	src := fmt.Sprintf(`// generated by fungen; DO NOT EDIT
            package %[1]s
	...
	for k1, v1 := range typeMap {
		src += generate(k1, v1+"List", typeMap)
		src = f(src)
	}
...
func generate(typeName, listname string, m map[string]string) string {
	code := ""
	code = fmt.Sprintf(`
